...
│   │   │                               # WorkflowDesigner (mapeo de slots).
│   │   │
...
│   │       ├── ColorPicker.jsx         # Selector de colores HSL
│   │       ├── SpacingControl.jsx      # Control de padding/margin/gap
│   │       ├── TypographyControl.jsx   # Control de fuente, tamaño, peso
│   │       └── BorderControl.jsx       # Control de bordes y radios
│   │
│   └── ── SHELL / LAYOUT ─────────────────────────────────────────────────────
│
│       ├── shell/
