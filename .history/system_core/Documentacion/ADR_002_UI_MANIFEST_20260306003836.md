...
| Grupo | Class | Acción Primaria |
|-------|-------|-----------------|
| **A — Schemas** | `DATA_SCHEMA` | Abrir `schema_designer.jsx` |
| **B — Documentos** | `DOCUMENT` | Abrir `DocumentDesigner.jsx` |
| **C — Logic Bridges** | `BRIDGE` | Abrir `BridgeDesigner.jsx` |
| **D — Apps** | `RUNNER` | Abrir `AEE_Dashboard.jsx` |

**Diagramación Técnica:** A diferencia del Nexus, el Dashboard es simétrico y basado en `grid-auto` para maximizar la densidad de información operativa.
