                    ...
                    <div className="stack--loose" style={{ maxWidth: '800px', margin: '0 auto', width: '100%' }}>
                        ...
                        <div className="spread glass" style={{ padding: 'var(--space-4)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)' }}>
                            ...
                            <div className="shelf--tight">
                                <button className="btn btn--sm btn--ghost">MATH</button>
                                <button className="btn btn--sm btn--ghost">TEXT</button>
                                <button className="btn btn--sm btn--ghost">EXTRACTOR</button>
                                <button className="btn btn--sm btn--ghost">EXPRESSION</button>
                            </div>
                        </div>
                        ...
                        {/* TODO: Lista de Tarjetas Operador */}
                    </div>
                </section>
