                ...
                <div className="fill shelf" style={{ overflow: 'hidden' }}>
                    ...
                    <section className="fill stack" style={{ overflowY: 'auto', padding: 'var(--space-8)' }}>
                        <div className="stack--loose" style={{ maxWidth: '800px', margin: '0 auto', width: '100%' }}>
                            ...
                            <div className="center" style={{ margin: 'var(--space-4) 0' }}>
                                <div className="shelf--tight glass-strong" style={{
                                    padding: 'var(--space-2)',
                                    borderRadius: 'var(--radius-pill)',
                                    border: '1px solid var(--color-border-strong)',
                                    gap: 'var(--space-2)'
                                }}>
                                    <span style={{ fontSize: '9px', opacity: 0.5, padding: '0 var(--space-2)', fontFamily: 'var(--font-mono)' }}>ADD_OP:</span>
                                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('MATH')} style={{ borderRadius: 'var(--radius-pill)' }}>MATH</button>
                                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('TEXT')} style={{ borderRadius: 'var(--radius-pill)' }}>TEXT</button>
                                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('EXTRACTOR')} style={{ borderRadius: 'var(--radius-pill)' }}>RESOLVER</button>
                                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('EXPRESSION')} style={{ borderRadius: 'var(--radius-pill)' }}>EXPRESSION</button>
                                </div>
                            </div>
