        ...
        <div className="stack" style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'var(--color-bg-void)', color: 'white', overflow: 'hidden', zIndex: 100 }}>
            ...
            <div className="shelf glass" style={{
                ...
                <div className="shelf--tight" style={{ gap: 'var(--space-1)' }}>
                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('MATH')} style={{ borderRadius: 'var(--radius-pill)', fontSize: '10px', opacity: 0.8 }}>MATH</button>
                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('TEXT')} style={{ borderRadius: 'var(--radius-pill)', fontSize: '10px', opacity: 0.8 }}>TEXT</button>
                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('EXTRACTOR')} style={{ borderRadius: 'var(--radius-pill)', fontSize: '10px', opacity: 0.8 }}>RESOLVER</button>
                    <button className="btn btn--xs btn--ghost" onClick={() => addOperator('EXPRESSION')} style={{ borderRadius: 'var(--radius-pill)', fontSize: '10px', opacity: 0.8 }}>EXPRESSION</button>
                </div>
            </div>
