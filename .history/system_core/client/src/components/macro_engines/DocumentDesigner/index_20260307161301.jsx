...
function DocumentDesignerShell({ atom, bridge }) {
    ...
    const saveDocument = async () => {
        ...
        try {
            ...
            console.log('[DocumentDesigner] Saved successfully via Bridge');
        } catch (err) {
    ...
    return (
        <div className="fill stack--tight" style={{ background: 'var(--color-bg-void)', overflow: 'hidden' }}>
            ...
            <TopRibbon
                ...
                onSave={saveDocument}
                onAddBlock={(type) => {
                    // Si no hay nada seleccionado, intentamos añadir al primer bloque (root) si es un FRAME
            ...
            <div className="fill" style={{
                ...
                <main className="fill stack" style={{
                    ...
                    minWidth: 0,
                    gap: 0,
                    display: 'block' // Cambiamos stack por block para scroll natural
                }}>

                    {/* HUD: PAGINATION & PRESETS */}
                    <div className="shelf--tight" style={{
                        position: 'sticky', // Sticky mejor que absolute para HUD flotante
                        top: 'var(--space-4)',
                        left: 'var(--space-4)',
                        zIndex: 100,
                ...
                <div className="stack--tight" style={{
                    ...
                    <div style={{ flex: 1, minHeight: 0, borderBottom: '1px solid var(--color-border)' }}>
