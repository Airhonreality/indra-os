...
export function LayerTree({ node, selectedId, onSelect, onMove, onRemove, depth }) {
            ...
            >
                ...
                {isSelected && (
                    <div className="shelf--tight" onClick={e => e.stopPropagation()} style={{ marginLeft: 'auto' }}>
                        <button className="btn btn--xs btn--ghost" onClick={() => onMove(node.id, -1)} style={{ border: 'none', padding: 0 }}>
