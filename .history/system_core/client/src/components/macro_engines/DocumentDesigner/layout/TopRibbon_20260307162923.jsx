        ...
        <div className="spread" style={{
            ...
            <div className="shelf--tight glass" style={{
                ...
                <button
                    ...
                    style={{ border: 'none', padding: 'var(--space-2)' }}
                >
                ...
                <div style={{ width: '1px', height: '12px', background: 'var(--color-border)', margin: '0 var(--space-2)' }} />

                <button
                    className="btn btn--xs btn--ghost"
                    onClick={() => setZoom(0.8)}
                    style={{ fontSize: '9px', border: 'none', color: 'var(--color-text-secondary)' }}
                >
                    BEST_FIT
                </button>
            </div>
