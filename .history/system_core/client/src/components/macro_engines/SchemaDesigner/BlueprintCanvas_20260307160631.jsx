    ...
    return (
        <div
            ...
            style={{
                ...
                background: isSelected ? 'rgba(var(--rgb-accent), 0.05)' : 'transparent',
        ...
        >
            <div className="spread" style={{ marginBottom: 'var(--space-2)' }}>
                <label style={{
                    ...
                    {field.label || 'CAMPO_SIN_NOMBRE'}
                    {field.config?.required && <span style={{ color: 'var(--color-danger)', marginLeft: '4px' }}>*</span>}
                </label>
                <span style={{ fontSize: '8px', opacity: 0.3, fontFamily: 'var(--font-mono)' }}>{field.type}</span>
            </div>
            ...
            {!isContainer ? (
                <div style={{
                    ...
                    {field.config?.placeholder || 'Esperando entrada...'}
                </div>
            ) : (
                <div style={{
                    padding: 'var(--space-4)',
                    ...
                    <div className="center" style={{ opacity: 0.2 }}>
                        <IndraIcon name="FRAME" size="20px" />
                        <span style={{ fontSize: '9px', marginLeft: 'var(--space-2)' }}>{field.type}_CONTAINER</span>
                    </div>
                </div>
            )}
        </div>
