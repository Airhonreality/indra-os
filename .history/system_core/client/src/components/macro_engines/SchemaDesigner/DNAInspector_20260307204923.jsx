...
export function DNAInspector({ field, onUpdate, allFields, onReparent, bridge }) {
    ...
    return (
        <aside className="stack" style={{
            ...
            <div className="spread" style={{ flexShrink: 0, padding: 'var(--space-4) var(--space-6)', borderBottom: '1px solid var(--color-border)' }}>
                <span style={{ fontSize: '10px', fontFamily: 'var(--font-mono)', fontWeight: 'bold', opacity: 0.6 }}>DNA_INSPECTOR</span>
                <IndraIcon name="DNA" size="14px" color={projection.theme.color} />
            </div>
