...
export function SchemaDesigner({ atom, bridge }) {
    ...
    // 1. Hidratación Única (Vía Bridge)
    useEffect(() => {
    ...
    // 3. Garantía de Persistencia (Auto-Flush)
    useEffect(() => {
            ...
            <header className="spread glass" style={{
                ...
                <div className="shelf--loose fill">
                    ...
                    <div className="stack--tight fill" style={{ maxWidth: '400px' }}>
                        ...
                        <span style={{
                            fontSize: '9px',
                            opacity: hasCollisions ? 1 : 0.5,
                            fontFamily: 'var(--font-mono)',
                            color: hasCollisions ? 'var(--color-danger)' : 'inherit',
                            fontWeight: hasCollisions ? 'bold' : 'normal'
                        }}>
                            {hasCollisions
