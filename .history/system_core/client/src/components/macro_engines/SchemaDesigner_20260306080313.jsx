            ...
            <header className="spread glass" style={{
                ...
                <div className="shelf--loose">
                    <div style={{ color: 'var(--color-accent)' }}>
                        <IndraActionTrigger icon="SCHEMA" size="20px" activeColor="var(--color-accent)" />
                    </div>
                    <div className="stack--tight">
                        <h2 style={{ margin: 0, fontSize: 'var(--text-lg)', fontFamily: 'var(--font-mono)' }}>
                            {localAtom.handle?.label}
                        </h2>
                ...
                <div className="shelf">
                    <button
                        className={`btn ${previewMode ? 'btn--accent' : 'btn--ghost'}`}
