            ...
            <main className="engine-canvas pipeline-viewport">
                ...
                <section className="station-stack">
                    {workflow.stations.map((station, index) => (
                        <div key={station.id} className={`station-node type-${station.type.toLowerCase()}`}>
                            ...
                            <div className="node-actions">
                                ...
                                <button className="icon-btn danger" title="Eliminar" onClick={() => removeStation(station.id)}>×</button>
                            </div>
                        </div>
                    ))}
