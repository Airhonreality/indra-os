            ...
            <div className="stack glass-strong" style={{
                ...
                <div className="fill stack--tight" style={{ overflowY: 'auto', padding: 'var(--space-2)' }}>
                    {filtered.map(slot => (
                        ...
                        >
                            <IndraIcon name={slot.icon} size="12px" style={{ opacity: 0.5 }} />
                            <div className="stack--tight fill">
                                <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)' }}>{slot.label}</span>
                                <span style={{ fontSize: '8px', opacity: 0.3 }}>{slot.path}</span>
                            </div>
                            <span style={{ fontSize: '8px', opacity: 0.5, fontFamily: 'var(--font-mono)', border: '1px solid rgba(255,255,255,0.1)', padding: '2px 4px', borderRadius: '4px' }}>
                                {slot.type}
                            </span>
                        </div>
                    ))}
