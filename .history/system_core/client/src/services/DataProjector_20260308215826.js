...
export class DataProjector {
    ...
    static projectSchema(schemaSource) {
        ...
        // ADR_008: El sistema es sincero. No adivinamos, proyectamos el átomo.
        const label = schemaSource.handle?.label || 'UNTITLED_SCHEMA';
        const id = schemaSource.id;
        const rawFields = schemaSource.payload?.fields || [];

        // Proyección Recursiva (Mantiene la jerarquía del diseño)
