...
const LEXICON = {
    es: {
        ...
        // Motores y Clases
        DATA_SCHEMA: "DISEÑADOR_SCHEMA",
        LOGIC_BRIDGE: "PUENTE_LÓGICO",
        DOCUMENT_TEMPLATE: "PLANTILLA_DOC",
        STORAGE_SILO: "SILO_ALMACÉN",
        ACCOUNT: "IDENTIDAD_CORE",
