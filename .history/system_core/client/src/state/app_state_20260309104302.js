...
export const useAppState = create((set, get) => ({
    ...
    bootstrap: async () => {
        ...
        try {
            ...
            console.error('[app_state] Bootstrap verification failed (Continuidad Preservada):', err);
            // No llamamos a disconnect(). Dejamos que el usuario reintente o vea el error.
        }
    }
}));
