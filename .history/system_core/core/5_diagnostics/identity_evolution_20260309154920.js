...
function _projectToSincerity_(legacy, fileId, fileName) {
    ...
    // 1. Forzar Clase y ID real (Inmutabilidad de Infraestructura)
    evolved.class = (legacy.class || 'ITEM').toUpperCase();
    evolved.id = fileId;

    // 2. Inyectar Identidad Robusta (IUH v3.0)
    // No basta con que exista handle; debe ser completo (Sinceridad Radical)
