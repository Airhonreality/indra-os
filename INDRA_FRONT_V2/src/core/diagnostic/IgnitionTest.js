/**
 * src/core/diagnostic/IgnitionTest.js
...
import assembler from '../SystemAssembler';
...
async function runDiagnostic() {
    ...
    // (Simulando que el compilador lee una carpeta de leyes estructurales)
    ...
    const compiledProbe = {
        ...
        intent_rules: compiler.registry.INTENTS[probeLaw.config.intent]
    };
