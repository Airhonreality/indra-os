...
function _setupSystemInitializerTests() {
  ...
  const mocks = {
    mockManifest: {
      ANCHOR_PROPERTY: 'AXIOM_CORE_ROOT_ID',
      DRIVE_SCHEMA: {
        ROOT: { NAME: 'IndraCore' },
...
function testSystemInitializer_Verificacion_noDebeHacerNadaSiTodoEstaConfigurado() {
  ...
  try {
    ...
    setup.mocks._state.storedProperties['AXIOM_CORE_ROOT_ID'] = 'root-id';
    ...
    setup.mocks._state.storedProperties['AXIOM_CORE_SATELLITE_API_KEY'] = 'mock-satellite-key';
    setup.mocks._state.storedProperties['AXIOM_FOLDER_JSON_FLOWS_FOLDER_ID'] = 'folder-id';
