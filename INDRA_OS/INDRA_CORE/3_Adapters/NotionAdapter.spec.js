...
function testNotionAdapter_RetrievePageAplanificaPropiedades() {
  ...
  try {
    ...
    if (result.content.properties['Title'] !== 'Mi Página') {
      throw new Error('FALLO: Title no aplanificado');
    }

    if (result.content.properties['Email'] !== 'test@example.com') {
