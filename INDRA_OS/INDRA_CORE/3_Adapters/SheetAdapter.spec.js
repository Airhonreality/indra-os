...
// ======================================================================
// Tests de Helpers de Mapeo de Datos
...
// ======================================================================
// Tests para getRows() (Lectura Batch)
...
function testSheetAdapter_getRows_happyPath() {
  ...
  try {
    ...
    assert.areEqual('STRING', result.SCHEMA.columns[0].type, "Tipo por defecto debe ser STRING");
...
function testSheetAdapter_getRows_sheetVacia() {
  ...
  try {
    ...
    assert.areEqual(0, (result.items || result).length, "Sheet vacío debe retornar array vacío");
