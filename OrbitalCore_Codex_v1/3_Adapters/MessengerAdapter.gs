    ...
    const schemas = {
        ...
        receive: {
            ...
            io_interface: {
                ...
                outputs: {
                    senderId: { type: "string", io_behavior: "GATE", description: "Normalized sender identifier." },
                    body: { type: "string", io_behavior: "STREAM", description: "Normalized linguistic content stream." },
                    platform: { type: "string", io_behavior: "SCHEMA", description: "Original source platform." },
                    timestamp: { type: "number", io_behavior: "STREAM", description: "Normalized temporal marker." }
                }
            }
        },
        broadcast: {
