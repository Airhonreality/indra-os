  ...
  const schemas = {
    getUserProfile: {
      ...
      io_interface: {
        ...
        outputs: {
          profile: { type: "object", io_behavior: "STREAM", description: "Standardized profile data stream." }
        }
      }
    },
    getVideos: {
    ...
    getVideoComments: {
      ...
      io_interface: {
        ...
        outputs: {
          comments: { type: "array", io_behavior: "STREAM", description: "Collection of linguistic comment streams." }
        }
      }
    },
    replyComment: {
