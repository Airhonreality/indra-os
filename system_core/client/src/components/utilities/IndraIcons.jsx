...
const ICON_MAP = {
    ...
    'GOOGLE': <path d="M15 8.1c0-.5 0-1-.1-1.5H8v2.8h3.9c-.2 1-.7 1.8-1.6 2.4v2h2.6c1.5-1.4 2.1-3.4 2.1-5.7z" fill="#4285F4" stroke="none"/><path d="M8 15c1.9 0 3.5-.6 4.7-1.7l-2.6-2c-.7.5-1.5.8-2.1.8-1.6 0-3-1.1-3.5-2.5H1.8v2c1.2 2.4 3.7 4.4 6.2 4.4z" fill="#34A853" stroke="none"/><path d="M4.5 9.6c-.1-.3-.2-.7-.2-1.1s.1-.8.2-1.1v-2H1.8C1.3 6.4 1 7.2 1 8s.3 1.6.8 2.6l2.7-2z" fill="#FBBC05" stroke="none"/><path d="M8 3.5c1 0 2 .4 2.7 1l2-2C11.5 1.5 9.9 1 8 1 5.5 1 3 3 1.8 5.4l2.7 2c.5-1.4 1.9-2.5 3.5-2.5z" fill="#EA4335" stroke="none"/>
};
